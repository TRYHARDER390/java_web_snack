...
CREATE TABLE `account`  (
  ...
  `m_time` date NULL DEFAULT NULL,
  `m_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '充值/消费/提现',
  `m_amoney` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `admin` VALUES (2, 'admin1', 'admin', 1);
INSERT INTO `admin` VALUES (3, '商家1', '123456', 2);
INSERT INTO `admin` VALUES (4, 'shangjia1', '123456', 2);
...
INSERT INTO `admin_menu` VALUES (2, '用户管理');
...
-- ----------------------------
INSERT INTO `admin_menu_child` VALUES (1, '买家管理', 2, '/admin/user/mainToUserinfo');
INSERT INTO `admin_menu_child` VALUES (2, '商家管理', 2, '/admin/user/mainToAdmin');
...
CREATE TABLE `comment`  (
  ...
  `e_parentId` int(11) NULL DEFAULT NULL COMMENT '追评',
  `s_id` int(11) NULL DEFAULT NULL,
  `u_id` int(11) NULL DEFAULT NULL COMMENT '用户ID',
  `e_pictureName` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上传的图片名字',
  `e_type` int(11) NULL DEFAULT NULL COMMENT '1=好评，0，-1差评',
  `e_score` int(11) NULL DEFAULT NULL COMMENT '评分',
  `info` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '评语',
  `e_date` date NULL DEFAULT NULL COMMENT '评价日期',
...
CREATE TABLE `integral`  (
  ...
  `u_id` int(11) NULL DEFAULT NULL COMMENT '用户id',
  `i_number` int(11) NULL DEFAULT NULL COMMENT '获得积分',
  `i_time` date NULL DEFAULT NULL COMMENT '操作时间',
  `i_dese` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
...
CREATE TABLE `order`  (
  ...
  `u_id` int(11) NULL DEFAULT NULL,
  `e_id` int(11) NULL DEFAULT NULL COMMENT '操作员ID',
  `o_time` date NULL DEFAULT NULL,
  `o_type` int(11) NULL DEFAULT NULL COMMENT '-1:未发货；1:完成，0：已发货',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `order` VALUES (133, '202011022308', 22, NULL, '2020-11-02', -2);
...
CREATE TABLE `orderdetail`  (
  ...
  `s_id` int(11) NULL DEFAULT NULL,
  `o_num` int(11) NULL DEFAULT NULL,
...
INSERT INTO `orderdetail` VALUES (170, '202011022308', 68, 1, 5);
INSERT INTO `orderdetail` VALUES (171, '202011022308', 39, 1, 20);
...
CREATE TABLE `permission`  (
  ...
  `isparent` int(11) NULL DEFAULT NULL,
...
INSERT INTO `receiptinfo` VALUES (139, '202011022308', '13', '13889876456', '312');
...
INSERT INTO `role` VALUES (2, '商家', '零食管理');
...
CREATE TABLE `snackinfo`  (
  ...
  `s_Imported` int(1) NULL DEFAULT NULL COMMENT '是否进口',
  `s_score` int(11) NULL DEFAULT NULL COMMENT '积分',
  ...
  `state` int(11) NULL DEFAULT NULL COMMENT '1---上架，0---草稿，-1--下架',
  ...
  `s_number` int(11) NULL DEFAULT NULL COMMENT '数量',
...
CREATE TABLE `userinfo`  (
  ...
  `u_score` int(11) NULL DEFAULT NULL COMMENT '积分总数',
...
INSERT INTO `userinfo` VALUES (18, 'stul5327', 'yuanlairuci', '123', '11091.0', '13520109202', '11932844180@qq.com', '男', '2018-11-04', '北京', 1);
INSERT INTO `userinfo` VALUES (19, 'stul5327', 'stul5327', '123', '9930.0', '13656565656', '123456@qq.com', '女', '2018-12-05', '上海', NULL);
INSERT INTO `userinfo` VALUES (20, 'stul5327', 'artisan', '123', '9837.0', '13565659898', 'artusan@qq.com', '男', '2018-12-07', '上海市 浦东新区', NULL);
INSERT INTO `userinfo` VALUES (21, '1', '123', '123', '10000', '17317899778', '123@qq.com', '男', '2020-11-02', '123', NULL);
INSERT INTO `userinfo` VALUES (22, 'ahfk', '1234', '1234', '9975.0', '17317899778', '532754@qq.com', '女', '2020-11-02', '123321', NULL);
INSERT INTO `userinfo` VALUES (23, '1', '1', '1', '10000', '13998789745', '1@qq.com', '男', '2020-11-05', '1', NULL);
